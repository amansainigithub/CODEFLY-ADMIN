...
export class VariantCategoryComponent {
  ...
  deleteVariantCategoryByid(bornCategoryId: any) {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        //save File
        this.variantCategoryService
          .deleteVariantCategoryByIdService(bornCategoryId)
          .subscribe({
            next: (res: any) => {
              this.toast.success({
                detail: 'Success',
  ...
  saveVariantCategory() {
    this.variantCategoryService
      .saveVariantCategoryService(this.form)
      .subscribe({
        next: (res: any) => {
          this.toast.success({
            detail: 'Success',
            summary: 'Variant Saved Success',
            position: 'bottomRight',
            duration: 3000,
          });
          this.spinner.hide();
  ...
  updateVariantCategory() {
    ...
    this.variantCategoryService
      .updateVariantCategory(this.updateform)
      .subscribe({
        next: (res: any) => {
          this.toast.success({
            detail: 'Success',
  ...
  getVariantCategoryById(bornCategoryid: any) {
    ...
    bornCategoryid;
    this.variantCategoryService
      .getVariantCategoryByIdService(bornCategoryid)
      .subscribe({
        next: (res: any) => {
