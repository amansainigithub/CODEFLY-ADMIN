...
applyFilter(event: Event) {
  ...
  { 
    Swal.fire({
        ...
        //save File
      this.typeCategoryService.deleteTypeCategoryByIdService(babyCategoryId).subscribe({
        next:(res:any)=> {
  ...
  getTypeCategoryById(childCategoryId: any) {
    ...
    this.typeCategoryService.getTypeCategoryByIdService(childCategoryId).subscribe({
      next:(res:any)=> {
    ...
    openDialog(enterAnimationDuration: string, exitAnimationDuration: string,typeCategoryId:any): void {
