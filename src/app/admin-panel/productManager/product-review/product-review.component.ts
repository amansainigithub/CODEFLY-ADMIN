...
export class ProductReviewComponent {
    ...
    productData: any;
    constructor(
      private engineXAdminService: EngineXAdminService,
  ...
  getEngineX() {
    ...
    this.spinner.show();
    this.engineXAdminService.getEngineXAdmin(this.productData.variantId).subscribe(
      (data: any) => {
  ...
  loadProductData() {
    this.spinner.show();
    this.productDataService.loadProductDetails(this.productData.productId)
      .subscribe({
        next: (res: any) => {
