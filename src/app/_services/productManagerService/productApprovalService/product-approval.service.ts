...
export class ProductApprovalService {
    ...
    productDisApproved(productId:any): Observable<any> {
        return this.http.post(API_AUTHORIZA_URL + "productApprovalController/" + 'productDisApproved/' + productId , "", httpOptions);
    }
}
